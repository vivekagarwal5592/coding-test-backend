/**
* This is the Service layer where we have the business logic
 * for getting the stock data from the repository and process
 * it in order to send it to the front end.
* */
